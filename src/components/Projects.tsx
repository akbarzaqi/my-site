                    ...
                    project.repos && project.repos.length > 0 ? (
                      <div className="flex items-center gap-1.5">
                        {project.repos.map((repo) => (
                          <a
                            key={repo.label}
                            href={getProjectUrl(repo.url)}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-medium bg-zinc-800/80 text-zinc-300 border border-zinc-700/80 hover:bg-zinc-700/80 hover:text-white transition-colors"
